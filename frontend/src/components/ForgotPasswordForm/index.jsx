...
const ForgotPasswordForm = () => {
	...
	return sendedEmail ? (
		...
		>
			<img src={MailBoxImg} style={{ width: 100, margin: '10px auto' }} alt="" />

			<h1 className="forgotpassword-heading">{t('Check Your Email')}!</h1>
			<span className="forgotpassword-subtext">
				{t('A Verification email has been sent to this email address')}: <br /> <b>{email}</b>
				<br /> <br />
				{t(
		...
		>
			<span className="forgotpassword-back">
				<NavLink to="/sign-in">
					<span style={{ fontSize: 16 }}>&#8592;</span> {t('Back to Sign-in')}
				</NavLink>
			</span>
			<h1 className="forgotpassword-heading">{t('Forgot Your Password')}?</h1>
			<span className="forgotpassword-subtext">
				{t('Do not worry! please enter the email address associated with your account')}.
			</span>
