...
const SignInForm = () => {
  ...
  return (
    ...
    >
      ...
      <span className="loginform-subtext">{t("It's great to have you back in Pet88")} 🥰</span>
      <SignInGoogle
      ...
      <section className="loginform-loginby">
      ...
      <span className="loginform-subtext_bottom">
        {t('Not a Pet88 member?')} <NavLink to="/sign-up">{t('Sign up for free')}</NavLink>
      </span>
    </motion.section>
  );
};
