...
export default function TableGrooming() {
	...
	return (
		<>
			<section className="tablegrooming-header">
				<section className="tablegrooming_leftheader">
					<h2 className="tablegrooming-header-title">{t('management grooming service')}</h2>
					<Button
				...
				<section className="tablegrooming_rightheader">
					<SearchTableInput
						columns={columns}
